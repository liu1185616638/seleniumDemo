...
# m3u8是本地的文件路径
m3u8_path = "D:\\PySpider\\playlist.m3u8"
...
if __name__ == '__main__':
    # urls = get_ts_urls(m3u8_path=m3u8_path, base_url="https://youku.letv-cdn.com/2019/08/07/VX60SrY8hItErZXA/")
    # download(urls, "D:\\PySpider\\tsfiles")
    combine("D:/PySpider/tsfiles", "D://PySpider//ts", "test")
